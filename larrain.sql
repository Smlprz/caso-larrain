...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 26-06-2025 a las 00:42:29
...
INSERT INTO `carrito` (`idcarrito`, `estado`) VALUES
(1, 'activo'),
(2, 'activo');
...
(10, 'Laptop Lenovo Legion Gamer', 1, 800000),
(20, 'Lenovo Thinkpad', 10, 1000000);
...
INSERT INTO `producto_carrito` (`idcarrito`, `idproducto`, `cantidadproducto`, `precio`) VALUES
(1, 10, 4, 800000);
...
INSERT INTO `venta` (`idventa`, `idcarrito`, `totalprecio`, `envio`, `fecha`) VALUES
(1, 1, 3200000, 'pendiente', '2025-06-26');
...
--
ALTER TABLE `venta`
  ADD CONSTRAINT `venta_ibfk_1` FOREIGN KEY (`idcarrito`) REFERENCES `carrito` (`idcarrito`) ON UPDATE CASCADE;
COMMIT;
